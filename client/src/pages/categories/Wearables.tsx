...
import { Watch, ChevronRight, Filter } from 'lucide-react';
import { Link } from 'wouter';

export default function Wearables() {
  const filters = [
    { name: 'All Wearables', count: 124 },
    { name: 'Smartwatches', count: 67 },
    { name: 'Fitness Trackers', count: 43 },
    { name: 'Smart Rings', count: 14 },
  ];

  const brands = ['Apple', 'Samsung', 'Fitbit', 'Garmin', 'Amazfit', 'Huawei', 'Xiaomi', 'Fossil'];
  const priceRanges = [
    { label: 'Under $100', min: 0, max: 100 },
    { label: '$100 - $250', min: 100, max: 250 },
    { label: '$250 - $400', min: 250, max: 400 },
    { label: 'Over $400', min: 400, max: 99999 },
  ];
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-foreground/70">
              Track your fitness, monitor your health, and stay connected. 
              Discover smartwatches and fitness trackers for an active lifestyle.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="flex items-center justify-between gap-4 flex-wrap">
                <p className="text-foreground/60">
                  Showing <span className="font-semibold text-foreground">124</span> wearables
                </p>
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((i) => (
                  ...
                  >
                    <div className="aspect-square bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center">
                      <Watch size={64} className="text-accent/30 group-hover:text-accent/50 transition-colors" />
                    </div>
                    <div className="p-5 space-y-3">
                      ...
                      <p className="text-sm text-foreground/60 line-clamp-2">
                        Heart Rate, GPS, Sleep Tracking, 7-Day Battery, Waterproof
                      </p>
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-2xl font-bold text-accent">
                            ${(199 + i * 40).toLocaleString()}
                          </div>
                          <div className="text-xs text-foreground/40 line-through">
                            ${(279 + i * 40).toLocaleString()}
                          </div>
                        </div>
